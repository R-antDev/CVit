          ...
          <span className="text-3xl">
            <HiInformationCircle/>
                ...
                <section className="flex flex-col space-y-4">
                    <div>
                        <Input type="text" placeholder="Web Developer" label="Profession"/>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div>
                            <Input type="text" placeholder="British" label="Nationality"/>
                        </div>
                        <div>
                            <Input type="text" placeholder="English" label="Language"/>
                        </div>
                    </div>
                </section>
                <Button
